...
def select_action(state):
    ...
    eps_threshold = decay_epsilon(steps_done, current_reward=0, eps=eps, MODE='LINEAR', decay_rate=DECAY_RATE, decay_till=10000, start_val=EPS_START, end_val=EPS_END)
    eps = eps_threshold
    eps_arr.append(eps)
    if steps_done % 100 == 0:
        print(eps_threshold)
...
# Save episode_durations as a file
np.savetxt('./data4plot/epsilon/LINEAR_eps.txt', eps_arr)
