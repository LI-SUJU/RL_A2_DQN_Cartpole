...
plt.plot(episode_durations, alpha=0.3, color="orange")
...
plt.xlabel('Episode')
plt.ylabel('Duration')
plt.title('Comparisons of Network with Different Number of Layers')
plt.legend()
# Add text
text = f'Learning Rate: {LR}, Exploration Policy: Epsilon-Greedy,\nDimention of Hidden Layers: {HIDDEN_DIM}, Layer Count: {LAYER_COUNT}'
plt.text(0.02, 80, text, verticalalignment='top')
# Save plot
plt.savefig(f'./plots/layers_count/DQN_{num_episodes}.png')
